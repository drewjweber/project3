...
seperation %>%
  ...
  labs(x = "Avg Seperation",
       ...
       title = "Graph 1: Individual WR Performance",
...
seperation2 %>%
 ...
 stat_smooth(geom='line', alpha=0.5, se=FALSE, method='lm')+
  ...
  labs(x = "Avg Cushion",
       y = "Average Seperation",
       title = "Graph 3: Team WR Seperation") +
  #bw theme
  theme_bw() +
  #center title with hjust = 0.5
  theme(
...
time_to_throw_vs_Sticks %>%
  ...
  labs(x = "Average Time to Throw",
       ...
       title = "Graph 4: QB Agressiveness",
...
sack_data %>%
  ...
  labs(x = "Total EPA Lost via Sacks",
       ...
       title = "Graph 5: EPA Lost by Sacks",
...
Not all sacks are created equal. A sack on 1st and 10 is most likely much worse than a sack on 3rd and 20. It can ruin a drive or can be almost the same as an incompletion. This graphic shows how much [EPA is being lost on average and in total**.**]{.ul}The outliers are what should be noted most from this graphic. Wentz is a catastrophe, whereas Burrow lost the EPA but wasn't killed the Bengals every time he did it. Lamar Jackson and Josh Allen are freaks and it is interesting to see if the sack "avoiders" remain this way year over year.
...
x_cpoe %>%
  ...
  labs(x = "Completion % Above Expected ",
       y = "EPA per play",
       title = "Graph 6: Quarterback Efficiency 2021",
...
runners %>%
  ...
  labs(x = "YPC",
       y = "EPA per play",
       title = "Graph 8: Rushing Efficiency 2021",
