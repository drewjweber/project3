...
#	) 
#write.csv(pbp2021, "/Users/drew/Documents/pbp2021.csv")
...
#2020 Data
pbp <- load_pbp(2020)
write.csv(pbp, "/Users/drew/Documents/Season_20.csv")
...
#Next Gen Stats
#WR_nxt <- load_nextgen_stats(2021, stat_type = "receiving")
#WR_nxt <- WR_nxt %>%
 # filter(!is_na(avg_cushion), !is_na(avg_separation), !is_na(avg_yac_above_expectation))
#write.csv(WR_nxt, "/Users/drew/Documents/nxt_gen_2021_receiving.csv")
WR_nxt <- read.csv("/Users/drew/Documents/nxt_gen_2021_receiving.csv")


#nxt_2021 <- load_nextgen_stats(2021)
#write.csv(nxt_2021, "/Users/drew/Documents/nxt_gen_2021.csv")
nxt_2021 <- read.csv("/Users/drew/Documents/nxt_gen_2021.csv")
```
...
separation %>%
  ...
  geom_point(color = separation$team_color, cex=separation$targets / 50, alpha = .6) +
...
Separation is not created equal.  It is harder to create separation farther down the field than it is to catch a bubble screen behind the LOS.  A great performer here is Tyler Lockett, who is creating separation far down the field unlike many other players.  In contrast, Cole Beasley was the best separator in the NFL last year (Over 100 targets).  But here we can see his aDot is also the lowest. 
